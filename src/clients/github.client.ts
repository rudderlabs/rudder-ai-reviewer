/**
 * Shared GitHub API client for all GitHub operations
 */
...
/**
 * Common GitHub API client wrapper
...
export class GitHubClient {
   ...
   * @returns Array of file objects with filename, status, additions, deletions, and optional patch
   */
   ...
   *
   * @param context - GitHub PR context (owner, repo, prNumber)
   * @returns Object with PR metadata fields
   */
